...
const {setUserContribution, getTotalSecondsContributed} = require('../assets/js/thank-you')
const {readFileSync} = require('fs')
const {stringToHTML, mockLocalStorage} = require('./utils')

document.body = stringToHTML(readFileSync(`${__dirname}/../views/thank-you.ejs`, 'UTF-8'))
