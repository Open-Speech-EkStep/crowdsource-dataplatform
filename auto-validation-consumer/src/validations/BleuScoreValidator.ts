...
//             ngram = makeSafe(words.slice(j, j+i).join(" "));
...
// function bleuScoreObject(order, smoothed) {//4, true
...
//     var reflengths = [];
//     var segBleuObj = new bleuScoreObject(4, true);

//     // Split the test segment into words
//     tstWords = tstSegment.split(/\s+/);
