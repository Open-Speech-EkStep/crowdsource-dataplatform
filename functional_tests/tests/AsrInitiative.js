...
step(
  'When user click on Lets Go Button, user should <arg0> see instructions to record',
  async function (arg0) {
...
step('Validate Thank you page content for Speech Contribution', async function () {
  await taiko.waitFor(1000);
...
step('Validate Speech Contribution content', async function () {
