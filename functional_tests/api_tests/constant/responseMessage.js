const successfulFeedback = "Feedback submitted successfully.";
const badRequest = "Bad request";
const invalidQuery = "Invalid query";
const dataNotFound = "Data not found";
const userIdMissing = "User Id missing";
const successfulReport = "Reported successfully.";
const inputValueMissing = "Input values missing";
