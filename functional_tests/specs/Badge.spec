...
* should select "" radio button, "Contribute 5 sentences in Marathi and earn Suno India Bronze Bhasha Samarthak badge" text & "bronze","silver","gold","platinum" image exist by default
* User should select "Hindi" language from dropdown
* should select "validate-radio" radio button, "Validate 5 sentences in Hindi and earn Suno India Bronze Bhasha Samarthak badge" text & "bronze","silver","gold","platinum" image exist by default
* User should select "bolo" initiative from tab
* User select "silver_participation_badge" badge level
* should select "contribute-radio" radio button, "Contribute 50 recordings in Hindi and earn Bolo India Silver Bhasha Samarthak badge" text & "bronze","silver","gold","platinum" image exist by default
