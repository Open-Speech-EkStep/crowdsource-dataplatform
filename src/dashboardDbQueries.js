...
const cumulativeDataByState = "select state, total_speakers, total_contributions, total_validations from state_group_contributions;";
...
const topLanguagesBySpeakerContributions = "select language, total_speakers from language_group_contributions ORDER BY total_speakers DESC LIMIT 5;";

const topLanguagesByHoursContributed = "select language,ROUND(total_contributions::numeric/3600, 3) as total_contributions from language_group_contributions ORDER BY total_contributions DESC LIMIT 5;";
