...
describe('BleuScore', () => {
  it('should call validate with hindi english and same text should return true', () => {
  ...
  it('should call validate with assamese english and same text', () => {
    ...
    let result = bleuScore.validate(
      'Assamese-English',
      'this is a test',
      'test this a is this test a test this test this a is this test a test this'
    );
  ...
  it('should call validate with a language pair that does not exist in the constant array and should return true', () => {
    const bleuScore = new BleuScore();

    let result = bleuScore.validate('French-Latin', 'test', 'test1234567890');
