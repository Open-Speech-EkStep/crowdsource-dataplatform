...
const QuickTips = ({ showQuickTips, setQuickTips }: QuickTipsProps) => {
  ...
  return quickTips ? (
    ...
    >
      <Button
        ...
        variant="normal"
        className={`${styles.close} d-flex position-absolute rounded-50 p-1 border border-1 border-primary-40`}
      >
        <ImageBasePath src="/images/close_white.svg" width="20" height="20" alt="Close" />
      </Button>
      <div
        className={`${styles.label} rounded-4 d-flex flex-xl-column justify-content-lg-center align-items-center display-6 flex-shrink-0 my-3 py-3 py-xl-0`}
      >
        <ImageBasePath
          src="/images/bulb.svg"
          width="24"
      ...
      <div className="d-flex display-6 flex-fill flex-wrap px-xl-9 justify-content-start">
        ...
        <div className={`${styles.tip} d-flex flex-shrink-0 flex-column align-items-center text-center my-3`}>
          ...
          <span className="mt-2">
            <Trans i18nKey="tipFour" defaults="tipFour" components={{ b: <b />, i: <i /> }} />
          </span>
        </div>
        <span className={`${styles.sep} flex-fill mt-9`} />
        <div className={`${styles.tip} d-flex flex-shrink-0 flex-column align-items-center text-center my-3`}>
