    ...
    <Fragment>
      ...
      <div className="px-2 px-lg-0 pb-8 mt-13">
        <Container fluid="lg">
          ...
          <div>
            <p className="mb-4">Effective Date: &lt;date goes here&gt;</p>
            <p className="mb-4">
              This data collection and validation Web Application <b>(&quot;Website&quot;)</b> is an open
              source application by _________ &lt;company name goes here&gt;. The Website has been developed
              to invite people to contribute data to develop Speech Recognition, Text-to-Speech, Machine
              Translation and Optical Character Recognition for Indian languages <b>(“Purpose”).</b>
            </p>
          </div>
          <div>
            <p className="mb-4">
              The terms ‘you’, ‘your’ refer to anyone who accesses, uses or contributes to the Website{' '}
              <b>(“User”)</b>. These terms of use, as amended, govern the usage of the Website by its Users{' '}
              <b>(“Terms”)</b>. By using the Website, you have accepted and agree to be governed by these
              Terms, as may be amended from time to time.
            </p>
            <p className="mb-4">Users can participate in the following way on the Website</p>
            <ol className="mt-5 mb-8">
              <li>
                Record their voices on the ASR Initiative while reading prompted texts{' '}
              ...
              <li>
                Transcribe text on the TTS Initiative while listening to the audio clips{' '}
              ...
              <li>
                Translate a text on the Translation Initiative <b>(“Translated Texts”)</b> from one Indian
                language to another to create an open database of parallel translations.
              </li>
              <li>
                Label an image <b>(“Labelled Images”)</b> on the OCR Initiative while reading the text on the
                Image to create an open database of labelled images for optical character recognition.
              </li>
            </ol>
          </div>
          <div>
            ...
            <ol className="mt-5 mb-8">
              <li>
                Users can contribute and validate Voice Recordings, Transcribed Texts, Translated Texts and
                Labelled Images on the Website.
              </li>
              <li>
            ...
            <ol className="mt-5 mb-8">
              ...
              <li>
                _________ &lt;company name goes here&gt; reserves the right to make the Voice Recordings,
                Transcribed Texts, Translated Texts and Labelled Images available on a public database. Voice
                Recordings, Transcribed Texts, Translated Texts and Labelled Images will be available under
                the CC0 1.0 Universal (CC0 1.0) Public Domain Dedication. That means that they will be public
                and _________ &lt;company name goes here&gt; has waived all copyrights to the extent _________
                &lt;company name goes here&gt; can under law. If you participate by contributing your Voice
                ...
                Image on the Website, you consent to _________ &lt;company name goes here&gt; offering your
                Voice Recordings, Transcribed Texts, Translated Texts and Labelled Images to the public under
                the CC0 1.0 Universal (CC0 1.0) Public Domain Dedication.
              </li>
              <li>
                _________ &lt;company name goes here&gt; reserves the right to pre-screen or review Voice
                Recording, Transcribed Texts, Translated Texts and Labelled Images and to refuse to publish or
                delete any Voice Recordings, Transcribed Texts, Translated Texts and Labelled Images which it
                deems does not fulfill the Purpose.
              </li>
              <li>
            ...
            <div className="ms-5 mt-5 mb-8">
              ...
              Labelled Images, you agree that _________ &lt;company name goes here&gt; will not be liable in
              any way for any inability to use the Website, or for any claim arising out of these Terms.
              _________ &lt;company name goes here&gt; specifically disclaims the following: indirect,
              special, incidental, consequential or exemplary damages, direct or indirect damages for loss of
              goodwill, work stoppage, lost profits, loss of data or computer malfunction. You agree to
              indemnify and hold _________ &lt;company name goes here&gt; harmless for any liability or claim
              that comes as a result of contributing Voice Recordings, Transcribed Texts, Translated Texts and
              Labelled Images.
            </div>
            ...
            <div className="ms-5 mt-5 mb-8">
              ...
              <b>_________ &lt;company email goes here&gt;</b> with details of the alleged infringement and
            ...
            <ol className="mt-5 mb-8">
              <li>
                ...
                suspended. _________ &lt;company name goes here&gt; can also suspend or end anyone’s access to
            ...
            <div className="ms-5 mt-5">
              ...
              ________ &lt;city of jurisdiction&gt;, India.
            </div>
          </div>
          ...
          <div>
            ...
            <div className="ms-5 mt-5 mb-8">
              ...
              <ol className="mt-5 mb-8">
                <li>
                  ...
                  publicly for public consumption, for use under CC0 1.0 Universal (CC0 1.0) Public Domain
                  Dedication. No personal metadata that can be used to identify a User or their voices will be
                  collected or disclosed along with the Voice Recordings.
                </li>
                ...
                <li>
                  ...
                  precise location of any User cannot be determined. This will help _________ &lt;company name
                  goes here&gt; and other researchers to understand the demographic distribution of the
                  speakers in the dataset repository and to improve and create speech-to-text technology and
                  tools. Aggregated and anonymised demographic data may be used for the purposes of analysis
                  and may be shared to the public. Individual demographic data will not be shared to the
                  public.
                </li>
                ...
                <li>
                  ...
                  interact with the website so we can improve it. We also collect your location, and the
                  language preference on the Website to make sure it looks right for you.
                </li>
              </ol>
            </div>
            ...
            <div className="ms-5 mt-5 mb-8">
              {' '}
              Your data will be stored in electronic form using cloud services. _________ &lt;company name
              goes here&gt; may enter into agreements with third parties to store and process your information
              or data. These third parties will follow security standards to safeguard your information or
              data and _________ &lt;company name goes here&gt; will, on a reasonable basis, require such
              third parties to adopt reasonable security standards to safeguard your information or data.
            </div>
            ...
            <ol className="mt-5 mb-8">
              <li>
                _________ &lt;company name goes here&gt; cooperates with governments and law enforcement
                agencies or any third party by any order under law for the time being in force to enforce and
                comply with the law.
              </li>
              <li>
                Any information about you will be disclosed to the government or law enforcement officials or
                private parties as, in the sole discretion of _________ &lt;company name goes here&gt;, if we
                believe necessary or appropriate to respond to claims and legal process, to protect their
                property and rights or a third party, to protect the safety of the public or any person, or to
                prevent or stop any illegal, unethical or legally actionable activity. Your information or
                data may also be provided to various tax authorities upon any demand or request from them.
              </li>
              <li>
                ...
                completely out of the control of _________ &lt;company name goes here&gt;. _________
                &lt;company name goes here&gt; does not take any responsibility for such actions.
              </li>
            </ol>
            ...
            <div className="ms-5 mt-5">
              ...
              email request to <b>_________ &lt;company email goes here&gt;</b>. You also agree and
              acknowledge that certain data or information cannot be deleted, because it cannot be uniquely
              identified as that of the requesting User, or may be prohibited to be deleted as required under
              any applicable law, law enforcement requests or under any judicial proceedings.
            </div>
          </div>
          ...
          <div>
            <p className="mb-4">
              Unless otherwise indicated, the Website is Copyright 2020 _________ &lt;company name goes
              here&gt;.
            </p>
            <p className="mb-4">
