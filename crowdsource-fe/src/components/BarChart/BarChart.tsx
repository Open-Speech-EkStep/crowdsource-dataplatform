...
const BarChart = (props: ChartProps | any) => {
  ...
  useLayoutEffect(() => {
    ...
    columnTemplate.tooltipX = am4core.percent(50);
    columnTemplate.tooltipY = am4core.percent(0);
    columnTemplate.adapter.add('fill', (value: any, target: any, key: any) => {
      return am4core.color(props.colors[props.colors.length - 1 - target.dataItem.index]);
    });
    columnTemplate.adapter.add('stroke', (value: any, target: any, key: any) => {
      console.log(props.colors, target.dataItem.index);
      return am4core.color(props.colors[props.colors.length - 1 - target.dataItem.index]);
    });
