...
const Report = ({ onSuccess, action, initiative }: ReportProps) => {
  ...
  const reportSubheadingText = t(
    `${INITIATIVES_MAPPING[initiative]}${capitalizeFirstLetter(action)}ReportModalSubHeading`
  );

  return (
    <Fragment>
      <IconTextButton id="report" textDesktop={t('report')} onClick={showModal} altText="reportIconAlt">
