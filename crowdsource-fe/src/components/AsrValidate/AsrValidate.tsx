...
import styles from './AsrValidate.module.scss';
  ...
  useEffect(() => {
    if ((skipData || acceptData || rejectData) && !(skipError || acceptError || rejectError)) {
      if (currentDataIndex === contributionData.length) {
        router.push(`/${currentLocale}${routePaths.asrInitiativeValidateThankYou}`, undefined, {
        ...
        <Fragment>
          <div className="pt-4 px-2 px-lg-0 pb-8">
            <FunctionalHeader
              ...
              action={INITIATIVE_ACTIONS[INITIATIVES_MAPPING.asr]['validate']}
            />
            <Container fluid="lg" className="mt-5">
              <div data-testid="AsrValidate" className={`${styles.root}`}>
                <div
                ...
                <div className={`${styles.audioWrapper} d-flex flex-column justify-content-center`}>
                  <div className="d-none d-flex flex-column align-items-center text-center">
                    <div className="mt-2 mt-md-3">
                      ...
                      <audio
                        ref={audioEl}
                        data-testid="asrValidateAudioElement"
                        controls
