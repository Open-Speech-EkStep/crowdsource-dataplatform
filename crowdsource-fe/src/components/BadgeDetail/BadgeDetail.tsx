...
const BadgeDetail = () => {
  ...
  const [defaultInitiative, setDefaultInitiative] = useState<string>(INITIATIVES_MAPPING.suno);
  ...
  useEffect(() => {
    ...
    const moduleName = prevPath ? pageInitiativeRouteConstants[prevPath] : 'others';
    if (moduleName !== 'others') {
      ...
      setDefaultInitiative(moduleName);
