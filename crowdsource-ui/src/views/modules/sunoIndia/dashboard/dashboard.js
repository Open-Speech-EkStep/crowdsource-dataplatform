        ...
        .then((data) => {
            try {
                ...
                if (langaugeExists) {
                    ...
                    updateLineGraph(language, activeDurationText, 'asr',"Hrs transcribed","Hrs corrected");
...
$(document).ready(function () {
    ...
    $('#duration').on('click', (e) => {
        ...
        updateLineGraph(selectedLanguage, selectedDuration, 'asr',"Hrs transcribed","Hrs corrected");
    });
