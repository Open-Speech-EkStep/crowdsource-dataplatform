    ...
    <div class="col-3 pl-lg-4 pr-lg-5 pl-1 pl-md-2 pr-2 card1">
                                <div class="badge-detail-widget cursor-pointer text-center" id="bronze_participation_badge">
                                    <img src="${getLanguageBadge(
                                      ...
                                      source,
                                      initiative
                                    )}" class="my-badge-image" id="bronze" height="74" width="60" rel="popover" data-toggle="popover">
                            ...
                            <div class="col-3 pl-lg-4 pr-lg-5 pl-1 pl-md-2 pr-2 card2">
                                <div class="badge-detail-widget cursor-pointer text-center" id="silver_participation_badge">
                                    <img src="${getLanguageBadge(
                                      ...
                                      source,
                                      initiative
                                    )}" class="my-badge-image" id="silver" height="74" width="60" rel="popover" data-toggle="popover">
                                    <h6 class="mt-0 text-capitalize badge-level-heading">${
                                      localeString.silver
                                    }</h6>
                                </div>
                            ...
                            <div class="col-3 pr-lg-5 pl-1 pl-lg-4 pl-md-2 pr-2 card3">
                                <div class="badge-detail-widget cursor-pointer text-center" id="gold_participation_badge">
                                    <img src="${getLanguageBadge(
                                      ...
                                      source,
                                      initiative
                                    )}" class="my-badge-image" id="gold" height="74" width="60" rel="popover" data-toggle="popover">
                                    <h6 class="mt-0 text-capitalize badge-level-heading">${
                                      localeString.gold
                                    }</h6>
                                </div>
                            ...
                            <div class="col-3 pr-lg-5 pl-1 pl-lg-4 pl-md-2 pr-2 card4">
                                <div class="badge-detail-widget cursor-pointer text-center" id="platinum_participation_badge">
                                    <img src="${getLanguageBadge(
                                      ...
                                      source,
                                      initiative
                                    )}" class="my-badge-image" id="platinum" height="74" width="60" rel="popover" data-toggle="popover">
                                    <h6 class="mt-0 text-capitalize badge-level-heading">${
                                      localeString.platinum
                                    }</h6>
                                </div>
                            </div>
    `;
...
const renderCard = function (data, initiative, badge_color, source, language) {
  ...
  const localeInitiativeStr =
    localeString[`${initiative.charAt(0).toUpperCase() + initiative.slice(1)} India`];
...
const renderBadgeDetails = function (data, source, type, initiative, language, badge_color) {
  ...
  $(
    '#bronze_participation_badge, #silver_participation_badge ,#gold_participation_badge, #platinum_participation_badge'
  )
    .off('click')
    .on('click', e => {
      $('.badge-level-section').find('.bg-white').removeClass('bg-white');
...
const getBadgeData = (type, source, language, initiative, badge_color) => {
  performAPIRequest(`/rewards-info?type=${type}&source=${source}&language=${language}`)
    .then(data => renderBadgeDetails(data, source, type, initiative, language, badge_color))
    .catch(console.log);
};
