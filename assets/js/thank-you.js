...
const setUserContribution = (getTotalSecondsContributed) => {
    const $userContribution = $('#user-contribution');
    const totalSecondsContributed = getTotalSecondsContributed()
...
if (!(localSpeakerDataParsed && localSpeakerDataParsed.userName)) {
    ...
    const setProgressPercent = (getTotalSecondsContributed) => {
