...
AS
 SELECT COALESCE(contribution_by_language.language, validation_by_language.language) AS language,
    ...
    sum(contribution_by_language.total_contributions) as total_contributions,
    sum(validation_by_language.total_validations) as total_validations,
...
AS
 SELECT COALESCE(contribution_by_state.state, validation_by_state.state) AS state,
    ...
    sum(contribution_by_state.total_contributions) as total_contributions,
    sum(validation_by_state.total_validations) as total_validations,
