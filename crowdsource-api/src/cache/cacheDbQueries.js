...
count(distinct val.validation_id) as validation_count, NOT con.is_system auto_validate
...
cont.contributor_identifier::text || '-' || cont.user_name as contributed_by, string_agg(cont2.contributor_identifier::text || '-' || cont2.user_name, ', ') as skipped_by, 
count(distinct val.validation_id) validation_count, NOT con.is_system auto_validate
  from contributions con 
