...
dataset_row_id in (select dataset_row_id from dataset_row where assigned_for_profanity_check = false and type = $3 and LOWER(media->>'language') = LOWER($4) limit 20) returning returning dataset_row_id,dataset_row.media->>'data' as media`
